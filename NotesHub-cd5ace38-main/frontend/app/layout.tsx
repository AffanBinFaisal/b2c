...
export const metadata: Metadata = {
  title: "NotesHub - Intelligent Knowledge Management",
...
export default function RootLayout({
  ...
  return (
    <html lang="en" className="dark" suppressHydrationWarning>
      <body className={`${inter.className} antialiased bg-[#0f172a] text-slate-50 min-h-screen flex flex-col`} suppressHydrationWarning>
